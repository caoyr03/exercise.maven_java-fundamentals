...
public class StringUtilities {
    ...
    public static Character getMiddleCharacter(String inputValue){
        Integer n = inputValue.length();
        if(n % 2 == 0)
            return inputValue.charAt(n/2-1);
        else return inputValue.charAt(n/2);
    }
    ...
    public static String reverse(String stringToReverse){
        ...
        return stringToReverse.charAt(stringToReverse.length()-1) + reverse(stringToReverse.substring(0,stringToReverse.length()-1));
    }
}
